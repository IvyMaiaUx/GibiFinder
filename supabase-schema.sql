...
-- ============================================================
-- Table: reading_sessions (per-session reading time/pages, used for
-- avgSessionMs in the admin's per-manga stats). Previously only defined in
-- the standalone reading-sessions-migration.sql — a fresh deploy from this
-- file alone was missing the table the app already reads/writes live.
-- user_id is a plain TEXT (not a user_profiles FK) since it's a
-- write-heavy analytics log, not synced user state.
-- ============================================================
