  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 mb-16 mt-8">
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-6">
        ...
        >
          <h1 className="font-display text-5xl md:text-6xl text-black leading-none uppercase">
            QUAL É O GIBI?!
          </h1>
        </motion.div>
        ...
        >
          <p className="font-sans font-bold text-lg md:text-xl text-gray-800 leading-snug">
            Descubra qualquer quadrinho a partir de fotos da capa, títulos, nomes de personagens ou até falas marcantes!
          </p>
        </motion.div>
