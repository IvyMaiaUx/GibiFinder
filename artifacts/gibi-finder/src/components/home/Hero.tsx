...
export function Hero() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-0 mb-16 mt-8">
      {/* Left: Detective */}
      ...
      <div className="w-full md:w-1/2 flex flex-col items-center md:items-start gap-6 md:-ml-8">
        ...
        >
          <p className="font-sans font-bold text-lg md:text-xl text-gray-800 leading-snug">Descubra qualquer gibi, mangá ou HQ a partir de fotos, títulos ou falas!</p>
        </motion.div>
